...
const closet = [
  ...
  },
  {
    ...
    bodyStrategyLabels: ["拉长腿部比例"],
    sceneTags: ["office", "travel", "party"],
    sceneLabels: ["上班", "出游", "聚会"],
    riskTags: [],
    riskLabels: [],
    usageCount: 0,
    image: ""
  },
  {
    ...
    subCategoryLabel: "玛丽珍鞋",
    color: "black",
    colorLabel: "黑色",
    warmth: 1,
    formality: 3,
    sourceType: "wardrobe",
    styleTags: ["commute", "sweet_light"],
    styleLabels: ["通勤", "轻甜"],
    bodyStrategyTags: ["extend_leg"],
    bodyStrategyLabels: ["拉长腿部比例"],
    sceneTags: ["office", "dating", "party"],
    sceneLabels: ["上班", "约会", "聚会"],
    riskTags: [],
    riskLabels: [],
    usageCount: 0,
    image: ""
...
const manualImageJobs = [
  ...
  },
  {
    ...
    userId: "user-b",
    scene: "上班",
    imagePath: "/packages/test-assets/generated/users/user-b-office.png",
  ...
  },
  {
    ...
    userId: "user-c",
    scene: "逛街",
    imagePath: "/packages/test-assets/generated/users/user-c-shopping.png",
  ...
  },
  {
    ...
    userId: "user-d",
    scene: "聚会",
    imagePath: "/packages/test-assets/generated/users/user-d-party.png",
  ...
  },
  {
    ...
    userId: "user-e",
    scene: "约会",
    imagePath: "/packages/test-assets/generated/users/user-e-dating.png",
